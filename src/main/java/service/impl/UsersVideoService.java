...
public class UsersVideoService implements IUsersVideoService{
	...
	private UserlikesMapper likeMapper;
	...
	public UserlikesMapper getLikeMapper() {
		return likeMapper;
	}
	@Resource
	public void setLikeMapper(UserlikesMapper likeMapper) {
	...
	@Override
	public boolean dellikebyv(String vid) {
		UserlikesExample se = new UserlikesExample();
		UserlikesExample.Criteria sec = se.createCriteria();
		sec.andLikesEqualTo(vid);
		return likeMapper.deleteByExample(se)>0;
	}
	@Override
